...
const PrintAdmitCardPage: React.FC = () => {
  ...
  return (
    <div className="bg-gray-200 dark:bg-gray-900 min-h-screen p-4 sm:p-8 font-serif">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Printable Area */}
        <div className="bg-white p-2 relative shadow-2xl print:shadow-none" id="admit-card">
            <div className="border-8 border-gray-800 p-4 relative overflow-hidden" style={{borderStyle: 'double'}}>
                ...
                <div className="mt-4 text-xs font-semibold relative z-10">
                    <div className="grid grid-cols-2 gap-x-8 gap-y-1">
                        ...
                        <div className="flex"><span className="w-32">Center:</span><span className="border-b border-dotted border-black flex-grow px-2"></span></div>
                    </div>
                </div>
        ...
        <style>{`
            @media print {
                ...
                .text-white, .text-red-700, .text-blue-800 {
...
export default PrintAdmitCardPage;