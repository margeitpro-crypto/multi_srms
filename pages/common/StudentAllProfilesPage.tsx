...
const StudentAllProfilesPage: React.FC = () => {
  ...
  // Automatically trigger print when the component loads
  useEffect(() => {
    // Small delay to ensure page is fully rendered before printing
  ...
  return (
    <div className="animate-fade-in max-w-7xl mx-auto">
        ...
        {/* All Students Profiles Container */}
        <div className="space-y-6">
            {MOCK_ADMIN_STUDENTS.map((student) => {
                const school = MOCK_SCHOOLS.find(s => s.id === student.school_id) || null;
                                ...
                                <div className="relative">
                                    {student.photo_url ? (
                                        ...
                                        <div className="h-20 w-20 rounded-lg bg-white/20 flex items-center justify-center border-2 border-white/30 shadow print:h-16 print:w-16 print:rounded print:border print:border-white">
                                            <svg className="w-12 h-12 text-white/80 print:w-10 print:h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <style>{`
            @media print {
                ...
                /* Page break after each student profile */
...
export default StudentAllProfilesPage;